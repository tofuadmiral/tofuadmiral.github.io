...
<p class="${"svelte-1kk9opm"}">New look coming soon 👀</p>

<p class="${"svelte-1kk9opm"}">But you can still check out my resume or schedule a ☕️ chat!</p>
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"svelte-s3tl44"}"><ul class="${"svelte-s3tl44"}"><li1 class="${"svelte-s3tl44"}"><a${add_attribute("aria-current", segment === undefined ? "page" : undefined, 0)} href="${"."}" class="${"svelte-s3tl44"}"><strong><span style="${"color:#d83ccc"}">fuad ali</span></strong></a></li1>
		...
		<li3 class="${"svelte-s3tl44"}"><a class="${"icon svelte-s3tl44"}" rel="${"prefetch"}"${add_attribute("aria-current", segment === "right" ? "page" : undefined, 0)} href="${"http://linkedin.com/in/ahmedfuadali"}">${validate_component(FaLinkedin, "FaLinkedin").$$render($$result, {}, {}, {})}</a></li3>
		<li3 class="${"svelte-s3tl44"}"><a class="${"icon svelte-s3tl44"}" rel="${"prefetch"}"${add_attribute("aria-current", segment === "right" ? "page" : undefined, 0)} href="${"http://github.com/tofuadmiral"}">${validate_component(FaGithub, "FaGithub").$$render($$result, {}, {}, {})}</a></li3>
		<li3 class="${"svelte-s3tl44"}"><a class="${"icon svelte-s3tl44"}" rel="${"prefetch"}"${add_attribute("aria-current", segment === "right" ? "page" : undefined, 0)} href="${"http://instagram.com/tofuadmiral"}">${validate_component(FaInstagram, "FaInstagram").$$render($$result, {}, {}, {})}</a></li3>
		<li3 class="${"svelte-s3tl44"}"><a class="${"icon svelte-s3tl44"}" rel="${"prefetch"}"${add_attribute("aria-current", segment === "right" ? "page" : undefined, 0)} href="${"http://twitter.com/tofuadmiral"}">${validate_component(FaTwitter, "FaTwitter").$$render($$result, {}, {}, {})}</a></li3></ul></nav>`;
});
